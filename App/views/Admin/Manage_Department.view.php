...
<main id="main" class="main">
	...
	<div style="text-align: right;">
		<a href="Create_Department"><button class="btn btn-primary">+ Add New Department</button></a>
	</div>
	<br>
	...
	<section class="section dashboard">
		<div class="row">
			<div class="col-lg-12">
				<div class="card">
					<div class="card-body">
						<h5 class="card-title" style="text-align: center;">Manage Your Department Details</h5>
